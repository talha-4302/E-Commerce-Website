...
const Filter = ({ filters, setFilters, mobileFilterVisible, setMobileFilterVisible }) => {
  ...
  return (
    ...
    <div className={`fixed top-0 right-0 h-full bg-white z-50 transition-all duration-200 overflow-hidden lg:static lg:block lg:mt-[37px] lg:w-1/5 lg:h-full lg:bg-gray-50 lg:overflow-visible lg:p-6 ${mobileFilterVisible ? 'w-full' : 'w-0 lg:w-1/5'}`}>
